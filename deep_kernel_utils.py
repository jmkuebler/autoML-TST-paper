"""
File utils_HD.py from liu et al  https://github.com/fengliu90/DK-for-TST/blob/master/utils_HD.py
"""
...
def MMDu(Fea, len_s, Fea_org, sigma, sigma0=0.1, epsilon = 10**(-10), is_smooth=True, is_var_computed=True, use_1sample_U=True):
    ...
    # K_Ix = torch.eye(nx).cuda() # not needed
